...
using Lap.Model;
using Lap.Model.Models.HourEntry;
using Lap.Model.Pagination;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Design;
using Microsoft.IdentityModel.Tokens;

namespace LAP.Main.Contexts.HourEntry
{
    public class HourEntryContext : ModelBaseContext<Lap.Model.Models.HourEntry.HourEntry>
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<HourEntryContext> _logger;

        public HourEntryContext(DbContextOptions<ModelBaseContext<Lap.Model.Models.HourEntry.HourEntry>> options,
        ...
        public new async Task<HourEntryResult> Create(
            Lap.Model.Models.HourEntry.HourEntry hourEntry)
        {
        ...
        public new async Task<HourEntryResult> Edit(int id, Lap.Model.Models.HourEntry.HourEntry hourEntry)
        {
        ...
        public async Task<ModelResult<PagedResponseKeySet<Lap.Model.Models.HourEntry.HourEntry>>> GetAllPagedEntries(
            List<ColumnFilter> columnFilters, int reference, int pageSize, bool addDeleted, string? userId)
        {
            ...
            {
                var customFilter =
                    CustomExpressionFilter<Lap.Model.Models.HourEntry.HourEntry>.CreateFilter(columnFilters!);
            ...
            var pagedResponse = new PagedResponseKeySet<Lap.Model.Models.HourEntry.HourEntry>(result, newReference);

            return ModelResult<PagedResponseKeySet<Lap.Model.Models.HourEntry.HourEntry>>.Ok(pagedResponse);
        }

        private async Task<HourEntryResult> CalcProperties(Lap.Model.Models.HourEntry.HourEntry hourEntry)
        {
        ...
        public class HourEntryContextDesignTimeFactory : IDesignTimeDbContextFactory<HourEntryContext>
        {
            ...
            {
                var builder = new DbContextOptionsBuilder<ModelBaseContext<Lap.Model.Models.HourEntry.HourEntry>>();
